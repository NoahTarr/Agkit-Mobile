...
public class CameraAngleDetailVH extends BaseDetailViewHolder<CameraAngleEntity> {
    ...
    public CameraAngleDetailVH(@NonNull View view, WidgetChangeListener updateListener) {
    ...
    @Override
    protected void bindEntity(CameraAngleEntity entity) {
